...
import { Button, Card, Input, Label, Calendar, Popover, PopoverContent, PopoverTrigger } from "@/shared/components";
  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="mb-4 flex items-center gap-2 text-sm">
        ...
        <ChevronRight className="w-4 h-4 text-[#9CA3AF]" />
        <span className="text-[#0F766E] font-medium">Add User</span>
      </div>
      ...
      {/* Page Header */}
      <div className="mb-5">
        <h2 className="text-2xl font-semibold text-[#1F2937] mb-1">Add New User</h2>
        <p className="text-sm text-[#6B7280]">Set up a new corporate user profile with custom RAG data boundaries</p>
      </div>
